...
export const GAMES: Game[] = [
  ...
  },
  {
    ...
    long: 'Tu nave triangular flota en vacío absoluto. Dispara y rota para dividir rocas en fragmentos cada vez más pequeños. Recoge el power-up 3x para triplicar tu cadencia de disparo.',
    cat: 'SHOOTER',
    cover: 'cover-rocas',
    color: 'yellow',
    best: 41200,
